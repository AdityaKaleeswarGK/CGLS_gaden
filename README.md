...
This directory contains the core logic for running adaptive gas-source localization using an autonomous coverage robot within the GADEN simulation environment.

## Core Logic Files

The essential logic and algorithms are implemented in the following four core files:
...
![Localization Error Comparison](results/error_comparison.png)
...
**CUSUM Hazard Map**
![CUSUM Hazard - Exp_C](results/hazard_cusum_Exp_C.png)

**Baseline Hazard Map**
![Baseline Hazard - Exp_C](results/hazard_baseline_Exp_C.png)

**Difference Map (CUSUM - Baseline)**
![Difference - Exp_C](results/hazard_diff_Exp_C.png)

**Key Finding on Hazard Maps:**/home/gk/gaden_results/auto_coverage/full_ablation
...
![Coverage Comparison](results/coverage_comparison.png)
